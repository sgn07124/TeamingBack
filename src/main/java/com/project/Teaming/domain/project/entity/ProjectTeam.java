...
public class ProjectTeam extends BaseTimeEntity {
    ...
    public static ProjectTeam projectTeam(CreateTeamDto dto) {
        ...
        projectTeam.startDate = LocalDate.parse(dto.getStartDate());
        projectTeam.endDate = LocalDate.parse(dto.getEndDate());
        projectTeam.deadline = LocalDate.parse(dto.getDeadline());
